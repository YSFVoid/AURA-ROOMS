...
const guildSettingsSchema = new Schema(
    {
        ...
        musicDefaultVolume: { type: Number, default: 50, min: 0, max: 100 },
        musicAllowNonTemp: { type: Boolean, default: false },
        musicIdleDisconnect: { type: Number, default: 60, min: 5, max: 600 },
